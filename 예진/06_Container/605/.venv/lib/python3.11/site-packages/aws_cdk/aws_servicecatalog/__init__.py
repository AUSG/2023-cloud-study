...
class CfnCloudFormationProduct(
    ...
    def __init__(
        ...
        *,
        ...
        :param product_type: ``AWS::ServiceCatalog::CloudFormationProduct.ProductType``.
    ...
    class ProvisioningArtifactPropertiesProperty:
        def __init__(
            ...
            *,
            ...
            :param type: ``CfnCloudFormationProduct.ProvisioningArtifactPropertiesProperty.Type``.
